...
void AddLightDlg::OnBnClickedSrcPointchexkbox()
{
	...
	GetDlgItem(pos_x)->SetWindowTextA("-0.5");
	GetDlgItem(pos_y)->SetWindowTextA("-0.5");
	GetDlgItem(pos_z)->SetWindowTextA("-2");
...
void AddLightDlg::OnBnClickedParallelSrcchexkbox()
{
	...
	GetDlgItem(dir_x)->SetWindowTextA("0");
	GetDlgItem(dir_y)->SetWindowTextA("0");
